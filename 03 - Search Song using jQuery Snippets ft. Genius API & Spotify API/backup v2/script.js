...
function getSongDetails() {
    const geniusAccessToken = 'C5cur7K7SNVqx1TDLlFVuEqCTdPDrKlWHI7xWbyJuEvKufe7LVnUmpWFPzJOcOh_';
    ...
    axios.get(geniusApiUrl)
                    ...
                    .then(spotifyResponse => {
                        ...
                        if (spotifyTracks.length > 0) {
                            ...
                            const htmlResult = `
                                ...
                                <iframe src="https://open.spotify.com/embed/track/${spotifyId}" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                            </div>
                            `;
        ...
        .catch(error => {
            $('#result').html(`<p class="error">Genius Error: ${error.message}</p>`);
        });
}
